    ...
    return (
        <FormStyles>
            ...
            >
                ...
                <a
                    target='blank'
                    href={`https://api.whatsapp.com/send?phone=${import.meta.env.VITE_BOT_PHONE}&text=${encodeURIComponent('Olá, gostaria de recuperar meu login')}`}
                >
                    <p
