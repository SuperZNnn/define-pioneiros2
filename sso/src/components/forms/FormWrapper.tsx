    ...
    return (
        <FormStyle invert={formType}>
            ...
            <div className="form-container container">
                <ForgotPassword setUser={(user: User) => {setShowUser(user)}} setFormType={() => {setFormType(false)}} formType={formType}/>
                <LoginForm setFormType={() => {setFormType(true)}} formType={formType}/>
            </div>
        </FormStyle>
    )
}
...
const FormStyle = styled.section<{ invert: boolean }>`
    ...
    .side-info {
        ...
        transform: ${({ invert }) => (invert ? "translate(45vh, 0)" : "translate(0, 0)")};
        position: relative;
        z-index: 1;
        ...
        @media (max-width: 650px){
            transform: ${({ invert }) => (invert ? "translate(0, 35vh)" : "translate(0, 0)")};
        }
    }
