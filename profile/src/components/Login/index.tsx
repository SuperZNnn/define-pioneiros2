...
import { SsoEvents } from '@/services/client_consults';
...
export const LoginScreen = () => {
    ...
    const onSubmit = (data: { login: string; password: string }) => {
        ...
        SsoEvents.tryLogin(data.login, data.password)
            ...
            .catch((err) => {
                if (err.status === 404)
                    setError('login', { message: 'Usuário não encontrado!' });
                ...
                <div className={style.form_container}>
                    ...
                    >
                        ...
                        <a href='http://localhost:5174/redirect?for=http://localhost:4000&forgot=1'>
                            <p
                                className={`simple-text ${style.forgotpassword}`}
                            >
                                Esqueceu a senha?
                            </p>
                        </a>
                    ...
                    <div className={`${style.create_account} flex-container`}>
                        <a href='http://localhost:5174/register'>
                            <button className={`btn ${style.create_account}`}>
                                Criar nova conta
                            </button>
                        </a>
                    </div>
                    <div className={`${style.create_account}`}>
                        ...
                        <div
                            ...
                            style={{ marginTop: '1vh' }}
                        >
                            <a href='http://localhost:5174/redirect?for=http://localhost:4000/profile'>
                                <button
                                    style={{
                                        cursor: 'pointer',
                                        outline: 'none',
                                ...
                                >
                                    <Image
                                        src={
                                            'https://pioneirosdoadvento.com/assets/images/google_logo.png'
                                        }
                                        width={50}
                                        height={50}
